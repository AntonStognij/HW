...
const dinoOpion = {
    ...
    objRes: {},
    maxElemArr: 6,
    //функция заполняет обьект с нужными ключами
    fillObjRes(arr) {
        for (i = 0; i < arr.length; i++) {
            this.objRes[arr[i]] = "";
        }
    },
    //функция делает элемент
    ...
    //функция открывает нужный элемент и скрывает ненужные
    ...
    //функция позволяет корректно отображать данные с сделанным выбором элементов
