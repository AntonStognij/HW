...
const Basket = (arrPurchases=null) => {
...
//получаем данные с Storage
 ...
 if(purchases){
    ...
    createElem ("span", allSummBlockOldPrice, null, `${allSumm}`, "allSummBlockSpan")
    createElem("img", allSummBlockOldPrice, img, null, "priceOldLine")
    createElem ("span", allSummBlock, null, `${allSummOld}`, "allSummBlockSpan allSummBlockSpanOld")
