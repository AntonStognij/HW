...
const Order = ( img, nameArm, price, oldPrice, count) => {

    console.log(img, nameArm, price, oldPrice, count)
//условные характеристики
let imgLine = info.catalog.armchair[1].line;
console.log(imgLine)
const imgBtnDel = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
createElem ("button",order, null, imgBtnDel, "buttonDel")
return orderBlock
}
